	...
	var Cropit = (function () {
	  ...
	  _createClass(Cropit, [{
	    ...
	    value: function init() {
	      ...
	      this.$fileInput = this.options.$fileInput.attr({ accept: 'image/x-png, image/jpeg' });
	    ...
	    value: function loadImage(imageSrc) {
	      ...
	      if (imageSrc.indexOf('data') === 0) {
					...
					//override for image size if maximize image
					if(this.options.maximizeImageSize) {
						this.preImage.height = this.preImage.height * (this.previewSize.width / this.preImage.width);
						this.preImage.width = this.previewSize.width;
					}
	    ...
	    value: function onPreImageLoaded() {
	      if (this.shouldRejectImage({
	        ...
	        return;
					...
					if(this.options.maximizeImageSize) {
							this.image.width = this.preImage.width;
							this.image.height = this.preImage.height;
					}
				}
	  }, {
	    key: 'onImageLoaded',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var options = {
	  ...
	  values: [{
	    ...
	    name: 'noOffset',
	    type: 'boolean',
	    description: 'When set to true it prevents the center image function from executing',
	    'default': false
	  }, {
	    name: 'maximizeImageSize',
	    type: 'boolean',
	    description: 'When set to true sets image size to max window size',
	    'default': false
	  }],
